...
mkdir -p logs/l2_lmh_sft results/experiments/mgr_sid_l1_lmh_sweep_sft_eval_20260508

BRANCH_DIR="idea-discovery/2026-05-06_l2_local_multihop_rescue_tokenizers"
VARIANT="r690b_lmh_l1_weight040_l2_weight001_l3_weight002"
INDEX_PATH="/data/leejt/OneRec/output_weights/experiments/mgr_sid_l1_lmh_sweep_20260508/generated_indices/Industrial_and_Scientific.${VARIANT}.index.json"
...
SFT_MODEL="/data/leejt/OneRec/output_weights/experiments/mgr_sid_l1_lmh_sweep_sft_eval_20260508/${VARIANT}_title_on_desc_p05_4gpu/sft/final_checkpoint"
RESULT_PATH="results/experiments/mgr_sid_l1_lmh_sweep_sft_eval_20260508/final_result_sft_mgr_${VARIANT}_title_on_desc_p05_4gpu_Industrial_and_Scientific.json"
...
echo "[L1-SFT] prepare data_experiment variant: $VARIANT"
...
echo "[L1-SFT] recipe=title_history2sid_on + desc_align_p05"
echo "[L1-SFT] effective_batch=1024 micro_batch=2 world_size=$NPROC grad_accum=$((1024 / (2 * NPROC)))"
echo "[L1-SFT] start ${VARIANT} SFT on GPUs $GPU_LIST"
...
echo "[L1-SFT] start ${VARIANT} evaluate on GPUs $GPU_LIST"
...
echo "[L1-SFT] ${VARIANT} SFT/evaluate completed: $RESULT_PATH"
