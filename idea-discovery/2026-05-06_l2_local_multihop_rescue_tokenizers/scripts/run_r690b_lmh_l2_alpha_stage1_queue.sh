...
if [[ "$#" -lt 3 ]]; then
  ...
  echo "Variants: alpha015, alpha025, alpha050, alpha075" >&2
  exit 2
fi
...
CONFIG_DIR="$BRANCH_DIR/configs/stage1_l2_alpha"
CKPT_BASE="/data/leejt/OneRec/output_weights/experiments/mgr_sid_l2_alpha_20260510"
INDEX_DIR="$CKPT_BASE/generated_indices"
LOG_DIR="$ROOT_DIR/logs/l2_alpha_stage1"
...
variant_params() {
  case "$1" in
    alpha015)
      echo "r690b_lmh_l2_alpha015 1.0 0.15"
      ;;
    alpha025)
      echo "r690b_lmh_l2_alpha025 1.0 0.25"
      ;;
    alpha050)
      echo "r690b_lmh_l2_alpha050 1.0 0.50"
      ;;
    alpha075)
      echo "r690b_lmh_l2_alpha075 1.0 0.75"
      ;;
    *)
...
# Keep all non-graph hyperparameters aligned with the current R690b-LMH mainline.
