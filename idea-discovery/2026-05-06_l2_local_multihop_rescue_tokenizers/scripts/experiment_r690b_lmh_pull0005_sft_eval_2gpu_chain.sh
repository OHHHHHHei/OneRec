...
mkdir -p logs/l2_lmh_sft results/experiments/mgr_sid_l2_lmh_sweep_sft_eval_20260508

BRANCH_DIR="idea-discovery/2026-05-06_l2_local_multihop_rescue_tokenizers"
VARIANT="r690b_lmh_l2_contrastive_pull_weight0005"
...
SFT_MODEL="/data/leejt/OneRec/output_weights/experiments/mgr_sid_l2_lmh_sweep_sft_eval_20260508/${VARIANT}_title_on_desc_p05_2gpu/sft/final_checkpoint"
RESULT_PATH="results/experiments/mgr_sid_l2_lmh_sweep_sft_eval_20260508/final_result_sft_mgr_${VARIANT}_title_on_desc_p05_2gpu_Industrial_and_Scientific.json"
