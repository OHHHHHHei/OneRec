...
INDEX_PATH="/data/leejt/OneRec/output_weights/experiments/mgr_sid_l2_lmh_sweep_20260507/generated_indices/Industrial_and_Scientific.r690b_lmh_l2_contrastive_pull_weight001.index.json"
DATA_ROOT="data_experiment/Amazon/r690b_lmh_l2_contrastive_pull_weight001"
...
SFT_CONFIG="$BRANCH_DIR/configs/sft_industrial_r690b_lmh_l2_contrastive_pull_weight001_title_on_desc_p05_4gpu.yaml"
EVAL_CONFIG="$BRANCH_DIR/configs/evaluate_industrial_r690b_lmh_l2_contrastive_pull_weight001_title_on_desc_p05_4gpu.yaml"
...
echo "[CHAIN] prepare data_experiment variant: r690b_lmh_l2_contrastive_pull_weight001"
python "$PREPARE_SCRIPT" \
  --variant "r690b_lmh_l2_contrastive_pull_weight001=$INDEX_PATH"
...
echo "[CHAIN] start r690b_lmh_l2_contrastive_pull_weight001 SFT on GPUs $GPU_LIST"
bash ./sft.sh industrial "$SFT_CONFIG" \
  "runtime.cuda_visible_devices=$GPU_LIST" \
  "runtime.nproc_per_node=$NPROC"

echo "[CHAIN] start r690b_lmh_l2_contrastive_pull_weight001 evaluate on GPUs $GPU_LIST"
bash ./evaluate.sh sft industrial "$EVAL_CONFIG" \
  "runtime.cuda_visible_devices=$GPU_LIST" \
  "runtime.nproc_per_node=$NPROC"

echo "[CHAIN] r690b_lmh_l2_contrastive_pull_weight001 SFT/evaluate completed"
