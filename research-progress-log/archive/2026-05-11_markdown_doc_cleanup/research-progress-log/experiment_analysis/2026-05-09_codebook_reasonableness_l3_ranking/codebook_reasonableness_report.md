...
| L3 ranking=0.020 | 105 | 2304 | 3675 | 11 | 2 | 598 | 147 |
| L2=0.015 | 108 | 2619 | 3673 | 13 | 2 | 443 | 120 |
...
| L3 ranking=0.020 | 86.74% | 27.53% | 0.02% | 27.76% | 1.48% | 1.160 | 1.143 | 59.20% |
| L2=0.015 | 88.44% | 24.04% | 0.02% | 25.15% | 1.07% | 1.147 | 1.125 | 64.40% |
...
| L3 ranking=0.020 | 83.65% | 32.60% | 0.26% | 33.09% | 1.14% | 1.179 | 1.165 | 51.05% |
| L2=0.015 | 84.56% | 29.38% | 0.31% | 29.67% | 1.19% | 1.154 | 1.142 | 55.18% |
...
| L3 ranking=0.020 | 0.56% | 0.00% | 0.00% | 0.47% | 0.70% | 0.017 | 0.006 | 0.56% |
| L2=0.015 | 0.34% | 0.00% | 0.00% | 0.33% | 0.84% | 0.015 | 0.003 | 0.34% |
...
| L3 ranking=0.020 | 0.09% | 0.00% | 0.00% | 0.31% | 0.60% | 0.010 | 0.001 | 0.09% |
| L2=0.015 | 0.08% | 0.00% | 0.00% | 0.29% | 0.40% | 0.008 | 0.001 | 0.08% |
...
| L3=0.010 | available | 0.062210 | 0.079493 | 0.087108 | 0.097456 | 0.062210 | 0.092213 | 0.110523 | 0.142731 |
| L3 ranking=0.020 | pending | - | - | - | - | - | - | - | - |
| L2=0.015 | available | 0.062210 | 0.078212 | 0.084933 | 0.094080 | 0.062210 | 0.090227 | 0.106552 | 0.135010 |
...
1. pair（物品对） `1543` - `1738`; sim（语义相似度）=0.9990; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_251>', '<b_177>', '<c_232>']` vs `['<a_251>', '<b_177>', '<c_196>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_68>', '<b_126>', '<c_21>']` vs `['<a_68>', '<b_126>', '<c_152>']`; LCP=2, overlap=2
2. pair（物品对） `2014` - `2233`; sim（语义相似度）=0.9986; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_112>', '<b_240>', '<c_196>']` vs `['<a_112>', '<b_240>', '<c_224>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_4>', '<b_92>', '<c_0>']` vs `['<a_4>', '<b_92>', '<c_125>']`; LCP=2, overlap=2
3. pair（物品对） `753` - `2459`; sim（语义相似度）=0.9972; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_251>', '<b_52>', '<c_233>']` vs `['<a_251>', '<b_27>', '<c_183>']`; LCP=1, overlap=1
   - L2=0.015: `['<a_102>', '<b_77>', '<c_31>']` vs `['<a_102>', '<b_77>', '<c_2>']`; LCP=2, overlap=2
4. pair（物品对） `1543` - `1739`; sim（语义相似度）=0.9965; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_251>', '<b_177>', '<c_232>']` vs `['<a_251>', '<b_177>', '<c_119>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_68>', '<b_126>', '<c_21>']` vs `['<a_68>', '<b_126>', '<c_107>']`; LCP=2, overlap=2
5. pair（物品对） `3442` - `3469`; sim（语义相似度）=0.9963; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_165>', '<b_198>', '<c_210>']` vs `['<a_165>', '<b_198>', '<c_84>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_38>', '<b_68>', '<c_84>']` vs `['<a_38>', '<b_68>', '<c_7>']`; LCP=2, overlap=2
...
1. pair（物品对） `181` - `182`; sim（语义相似度）=1.0000; cooc（共现）=327; PPMI（正点互信息）=2.4351
   ...
   - L3 ranking=0.020: `['<a_177>', '<b_144>', '<c_0>']` vs `['<a_177>', '<b_144>', '<c_0>']`; LCP=3, overlap=3
   - L2=0.015: `['<a_78>', '<b_70>', '<c_0>']` vs `['<a_78>', '<b_70>', '<c_0>']`; LCP=3, overlap=3
2. pair（物品对） `417` - `418`; sim（语义相似度）=0.9918; cooc（共现）=204; PPMI（正点互信息）=3.1059
   ...
   - L3 ranking=0.020: `['<a_0>', '<b_132>', '<c_186>']` vs `['<a_0>', '<b_132>', '<c_36>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_229>', '<b_253>', '<c_141>']` vs `['<a_229>', '<b_161>', '<c_26>']`; LCP=1, overlap=1
3. pair（物品对） `119` - `526`; sim（语义相似度）=0.9473; cooc（共现）=157; PPMI（正点互信息）=3.9791
   ...
   - L3 ranking=0.020: `['<a_2>', '<b_37>', '<c_188>']` vs `['<a_2>', '<b_130>', '<c_193>']`; LCP=1, overlap=1
   - L2=0.015: `['<a_123>', '<b_219>', '<c_249>']` vs `['<a_123>', '<b_6>', '<c_195>']`; LCP=1, overlap=1
4. pair（物品对） `418` - `1452`; sim（语义相似度）=0.9879; cooc（共现）=111; PPMI（正点互信息）=3.3005
   ...
   - L3 ranking=0.020: `['<a_0>', '<b_132>', '<c_36>']` vs `['<a_0>', '<b_132>', '<c_1>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_229>', '<b_161>', '<c_26>']` vs `['<a_229>', '<b_161>', '<c_204>']`; LCP=2, overlap=2
5. pair（物品对） `1153` - `1156`; sim（语义相似度）=0.9990; cooc（共现）=75; PPMI（正点互信息）=4.1698
   ...
   - L3 ranking=0.020: `['<a_251>', '<b_155>', '<c_209>']` vs `['<a_251>', '<b_155>', '<c_21>']`; LCP=2, overlap=2
   - L2=0.015: `['<a_68>', '<b_84>', '<c_93>']` vs `['<a_68>', '<b_84>', '<c_73>']`; LCP=2, overlap=2
...
1. pair（物品对） `1205` - `2871`; sim（语义相似度）=0.7544; cooc（共现）=23; PPMI（正点互信息）=4.0595
   ...
   - L3 ranking=0.020: `['<a_178>', '<b_218>', '<c_3>']` vs `['<a_118>', '<b_124>', '<c_130>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_140>', '<b_228>', '<c_61>']` vs `['<a_171>', '<b_136>', '<c_75>']`; LCP=0, overlap=0
2. pair（物品对） `182` - `2938`; sim（语义相似度）=0.7431; cooc（共现）=17; PPMI（正点互信息）=3.1805
   ...
   - L3 ranking=0.020: `['<a_177>', '<b_144>', '<c_0>']` vs `['<a_236>', '<b_118>', '<c_118>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_78>', '<b_70>', '<c_0>']` vs `['<a_245>', '<b_17>', '<c_2>']`; LCP=0, overlap=0
3. pair（物品对） `182` - `218`; sim（语义相似度）=0.7337; cooc（共现）=14; PPMI（正点互信息）=2.1268
   ...
   - L3 ranking=0.020: `['<a_177>', '<b_144>', '<c_0>']` vs `['<a_31>', '<b_203>', '<c_152>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_78>', '<b_70>', '<c_0>']` vs `['<a_225>', '<b_39>', '<c_248>']`; LCP=0, overlap=0
4. pair（物品对） `181` - `944`; sim（语义相似度）=0.7494; cooc（共现）=14; PPMI（正点互信息）=1.7890
   ...
   - L3 ranking=0.020: `['<a_177>', '<b_144>', '<c_0>']` vs `['<a_186>', '<b_104>', '<c_24>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_78>', '<b_70>', '<c_0>']` vs `['<a_190>', '<b_244>', '<c_94>']`; LCP=0, overlap=0
...
1. pair（物品对） `586` - `2883`; sim（语义相似度）=0.5450; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_220>', '<b_14>', '<c_105>']` vs `['<a_112>', '<b_226>', '<c_15>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_200>', '<b_155>', '<c_91>']` vs `['<a_4>', '<b_226>', '<c_175>']`; LCP=0, overlap=0
2. pair（物品对） `101` - `586`; sim（语义相似度）=0.5577; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_112>', '<b_57>', '<c_158>']` vs `['<a_220>', '<b_14>', '<c_105>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_4>', '<b_8>', '<c_9>']` vs `['<a_200>', '<b_155>', '<c_91>']`; LCP=0, overlap=0
3. pair（物品对） `586` - `2916`; sim（语义相似度）=0.5612; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_220>', '<b_14>', '<c_105>']` vs `['<a_165>', '<b_110>', '<c_4>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_200>', '<b_155>', '<c_91>']` vs `['<a_38>', '<b_243>', '<c_193>']`; LCP=0, overlap=0
4. pair（物品对） `204` - `2602`; sim（语义相似度）=0.5613; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_41>', '<b_74>', '<c_12>']` vs `['<a_11>', '<b_53>', '<c_91>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_36>', '<b_159>', '<c_166>']` vs `['<a_200>', '<b_134>', '<c_98>']`; LCP=0, overlap=0
5. pair（物品对） `2602` - `3059`; sim（语义相似度）=0.5615; cooc（共现）=0; PPMI（正点互信息）=0.0000
   ...
   - L3 ranking=0.020: `['<a_11>', '<b_53>', '<c_91>']` vs `['<a_184>', '<b_166>', '<c_194>']`; LCP=0, overlap=0
   - L2=0.015: `['<a_200>', '<b_134>', '<c_98>']` vs `['<a_20>', '<b_158>', '<c_131>']`; LCP=0, overlap=0
...
- `metrics.json`: `/home/leejt/OneRec/research-progress-log/experiment_analysis/2026-05-09_codebook_reasonableness_l3_ranking/metrics.json`
- `structure_metrics.csv`: `/home/leejt/OneRec/research-progress-log/experiment_analysis/2026-05-09_codebook_reasonableness_l3_ranking/structure_metrics.csv`
- `pair_metrics.csv`: `/home/leejt/OneRec/research-progress-log/experiment_analysis/2026-05-09_codebook_reasonableness_l3_ranking/pair_metrics.csv`
- `pair_examples.json`: `/home/leejt/OneRec/research-progress-log/experiment_analysis/2026-05-09_codebook_reasonableness_l3_ranking/pair_examples.json`
