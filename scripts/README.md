...
## Preserved Current-Level Scripts（保留在当前层的脚本）

The following families（脚本族） remain at the root of `scripts/` to preserve historical reproducibility（历史复现性） and avoid breaking artifact pointers（产物指针）:
